    ...
    void show(@Nullable final InternalVisibilityChangedListener listener, final boolean fromUser) {
        if (!isOrWillBeShown()) {
            ...
            if (shouldAnimateVisibilityChange()) {
                ...
                this.mView.animate().scaleX(BaseField.BORDER_WIDTH_THIN).scaleY(BaseField.BORDER_WIDTH_THIN).alpha(BaseField.BORDER_WIDTH_THIN).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new AnimatorListenerAdapter() {
                    public void onAnimationStart(Animator animation) {
                        FloatingActionButtonIcs.this.mView.internalSetVisibility(0, fromUser);
                    }
            ...
            this.mView.setAlpha(BaseField.BORDER_WIDTH_THIN);
            this.mView.setScaleY(BaseField.BORDER_WIDTH_THIN);
            this.mView.setScaleX(BaseField.BORDER_WIDTH_THIN);
            if (listener != null) {
                listener.onShown();
            }
        }
