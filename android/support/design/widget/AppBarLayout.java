    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        private void animateOffsetTo(CoordinatorLayout coordinatorLayout, AppBarLayout child, int offset, float velocity) {
            ...
            if (velocity > 0.0f) {
                ...
                duration = (int) ((BaseField.BORDER_WIDTH_THIN + (((float) distance) / ((float) child.getHeight()))) * 150.0f);
            }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        float getOverlapRatioForOffset(View header) {
            ...
            if (availScrollRange != 0) {
                return BaseField.BORDER_WIDTH_THIN + (((float) offset) / ((float) availScrollRange));
            }
            return 0.0f;
        }
