...
public class BottomNavigationView extends FrameLayout {
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C00321());
        Bundle menuPresenterState;

        static class C00321 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C00321() {
            }
    ...
    public BottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenu.setCallback(new C00311());
    }
    ...
    private ColorStateList createDefaultColorStateList(int baseColorThemeAttr) {
        ...
        if (!getContext().getTheme().resolveAttribute(C0284R.attr.colorPrimary, value, true)) {
            return null;
        }
