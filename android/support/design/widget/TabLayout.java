...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        protected void onLayout(boolean changed, int l, int t, int r, int b) {
            ...
            this.mIndicatorAnimator.cancel();
            animateIndicatorToPosition(this.mSelectedPosition, Math.round((BaseField.BORDER_WIDTH_THIN - this.mIndicatorAnimator.getAnimatedFraction()) * ((float) this.mIndicatorAnimator.getDuration())));
        }
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.setFloatValues(0.0f, BaseField.BORDER_WIDTH_THIN);
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(this.mTabTextAppearance, C0284R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) ta.getDimensionPixelSize(C0284R.styleable.TextAppearance_android_textSize, 0);
            this.mTabTextColors = ta.getColorStateList(C0284R.styleable.TextAppearance_android_textColor);
    ...
    private void updateTabViewLayoutParams(LayoutParams lp) {
        if (this.mMode == 1 && this.mTabGravity == 0) {
            lp.width = 0;
            lp.weight = BaseField.BORDER_WIDTH_THIN;
            return;
        }
        lp.width = -2;
        lp.weight = 0.0f;
    ...
    private void ensureScrollAnimator() {
        if (this.mScrollAnimator == null) {
            ...
            this.mScrollAnimator.addUpdateListener(new C00561());
        }
    }
