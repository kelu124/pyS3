...
final class CollapsingTextHelper {
    ...
    void setCollapsedTextAppearance(int resId) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), resId, C0284R.styleable.TextAppearance);
        if (a.hasValue(C0284R.styleable.TextAppearance_android_textColor)) {
            this.mCollapsedTextColor = a.getColorStateList(C0284R.styleable.TextAppearance_android_textColor);
        }
        if (a.hasValue(C0284R.styleable.TextAppearance_android_textSize)) {
            this.mCollapsedTextSize = (float) a.getDimensionPixelSize(C0284R.styleable.TextAppearance_android_textSize, (int) this.mCollapsedTextSize);
        }
        this.mCollapsedShadowColor = a.getInt(C0284R.styleable.TextAppearance_android_shadowColor, 0);
        this.mCollapsedShadowDx = a.getFloat(C0284R.styleable.TextAppearance_android_shadowDx, 0.0f);
        this.mCollapsedShadowDy = a.getFloat(C0284R.styleable.TextAppearance_android_shadowDy, 0.0f);
        this.mCollapsedShadowRadius = a.getFloat(C0284R.styleable.TextAppearance_android_shadowRadius, 0.0f);
        a.recycle();
    ...
    void setExpandedTextAppearance(int resId) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), resId, C0284R.styleable.TextAppearance);
        if (a.hasValue(C0284R.styleable.TextAppearance_android_textColor)) {
            this.mExpandedTextColor = a.getColorStateList(C0284R.styleable.TextAppearance_android_textColor);
        }
        if (a.hasValue(C0284R.styleable.TextAppearance_android_textSize)) {
            this.mExpandedTextSize = (float) a.getDimensionPixelSize(C0284R.styleable.TextAppearance_android_textSize, (int) this.mExpandedTextSize);
        }
        this.mExpandedShadowColor = a.getInt(C0284R.styleable.TextAppearance_android_shadowColor, 0);
        this.mExpandedShadowDx = a.getFloat(C0284R.styleable.TextAppearance_android_shadowDx, 0.0f);
        this.mExpandedShadowDy = a.getFloat(C0284R.styleable.TextAppearance_android_shadowDy, 0.0f);
        this.mExpandedShadowRadius = a.getFloat(C0284R.styleable.TextAppearance_android_shadowRadius, 0.0f);
        a.recycle();
        if (VERSION.SDK_INT >= 16) {
    ...
    void setExpansionFraction(float fraction) {
        fraction = MathUtils.constrain(fraction, 0.0f, (float) BaseField.BORDER_WIDTH_THIN);
    ...
    private void calculateBaseOffsets() {
        ...
        switch (collapsedAbsGravity & 112) {
            ...
            case 80:
                ...
                break;
            default:
                this.mCollapsedDrawY = ((float) this.mCollapsedBounds.centerY()) + (((this.mTextPaint.descent() - this.mTextPaint.ascent()) / BaseField.BORDER_WIDTH_MEDIUM) - this.mTextPaint.descent());
                break;
        }
        switch (collapsedAbsGravity & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK) {
            case 1:
                this.mCollapsedDrawX = ((float) this.mCollapsedBounds.centerX()) - (width / BaseField.BORDER_WIDTH_MEDIUM);
                break;
            case 5:
        ...
        switch (expandedAbsGravity & 112) {
            ...
            case 80:
                ...
                break;
            default:
                this.mExpandedDrawY = ((float) this.mExpandedBounds.centerY()) + (((this.mTextPaint.descent() - this.mTextPaint.ascent()) / BaseField.BORDER_WIDTH_MEDIUM) - this.mTextPaint.descent());
                break;
        }
        switch (expandedAbsGravity & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK) {
            case 1:
                this.mExpandedDrawX = ((float) this.mExpandedBounds.centerX()) - (width / BaseField.BORDER_WIDTH_MEDIUM);
                break;
            case 5:
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mTextToDraw != null && this.mDrawTitle) {
            ...
            if (this.mScale != BaseField.BORDER_WIDTH_THIN) {
    ...
    private void setInterpolatedTextSize(float textSize) {
        ...
        boolean z = USE_SCALING_TEXTURE && this.mScale != BaseField.BORDER_WIDTH_THIN;
        this.mUseTexture = z;
        if (this.mUseTexture) {
    ...
    private void calculateUsingTextSize(float textSize) {
        ...
        if (this.mText != null) {
            ...
            if (isClose(textSize, this.mCollapsedTextSize)) {
                ...
                this.mScale = BaseField.BORDER_WIDTH_THIN;
    ...
    private static int blendColors(int color1, int color2, float ratio) {
        float inverseRatio = BaseField.BORDER_WIDTH_THIN - ratio;
