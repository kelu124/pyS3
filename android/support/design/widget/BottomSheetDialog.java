...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C00372 extends AccessibilityDelegateCompat {
        C00372() {
        }
    ...
    class C00383 extends BottomSheetCallback {
        C00383() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C00383();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        ...
        coordinator.findViewById(C0010R.id.touch_outside).setOnClickListener(new C00361());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C00372());
        return coordinator;
    }
