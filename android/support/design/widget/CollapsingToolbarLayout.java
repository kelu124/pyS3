...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C00401 implements OnApplyWindowInsetsListener {
        C00401() {
        }
    ...
    class C00412 implements AnimatorUpdateListener {
        C00412() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mCollapsingTextHelper.setCollapsedTextAppearance(C0284R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
        ...
        this.mScrimAnimationDuration = (long) a.getInt(C0010R.styleable.CollapsingToolbarLayout_scrimAnimationDuration, 600);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00401());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.addUpdateListener(new C00412());
