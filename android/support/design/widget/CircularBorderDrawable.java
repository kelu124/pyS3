...
class CircularBorderDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        float halfBorderWidth = this.mPaint.getStrokeWidth() / BaseField.BORDER_WIDTH_MEDIUM;
