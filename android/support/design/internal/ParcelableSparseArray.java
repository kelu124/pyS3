...
public class ParcelableSparseArray extends SparseArray<Parcelable> implements Parcelable {
    public static final Creator<ParcelableSparseArray> CREATOR = ParcelableCompat.newCreator(new C00151());

    static class C00151 implements ParcelableCompatCreatorCallbacks<ParcelableSparseArray> {
        C00151() {
        }
