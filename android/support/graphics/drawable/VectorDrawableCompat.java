...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private static class VFullPath extends VPath {
        float mFillAlpha = BaseField.BORDER_WIDTH_THIN;
        int mFillColor = 0;
        int mFillRule;
        float mStrokeAlpha = BaseField.BORDER_WIDTH_THIN;
        int mStrokeColor = 0;
        ...
        float mTrimPathEnd = BaseField.BORDER_WIDTH_THIN;
    ...
    private static class VGroup {
        ...
        float mRotate = 0.0f;
        private float mScaleX = BaseField.BORDER_WIDTH_THIN;
        private float mScaleY = BaseField.BORDER_WIDTH_THIN;
    ...
    private static class VPathRenderer {
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int w, int h, ColorFilter filter) {
            ...
            if (matrixScale != 0.0f) {
                ...
                if (!(fullPath.mTrimPathStart == 0.0f && fullPath.mTrimPathEnd == BaseField.BORDER_WIDTH_THIN)) {
                    float start = (fullPath.mTrimPathStart + fullPath.mTrimPathOffset) % BaseField.BORDER_WIDTH_THIN;
                    float end = (fullPath.mTrimPathEnd + fullPath.mTrimPathOffset) % BaseField.BORDER_WIDTH_THIN;
        ...
        private float getMatrixScale(Matrix groupStackedMatrix) {
            float[] unitVectors = new float[]{0.0f, BaseField.BORDER_WIDTH_THIN, BaseField.BORDER_WIDTH_THIN, 0.0f};
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mTmpBounds.width() > 0 && this.mTmpBounds.height() > 0) {
            ...
            if (!(canvasSkewX == 0.0f && canvasSkewY == 0.0f)) {
                canvasScaleX = BaseField.BORDER_WIDTH_THIN;
                canvasScaleY = BaseField.BORDER_WIDTH_THIN;
            }
            ...
            if (scaledWidth > 0 && scaledHeight > 0) {
                ...
                if (needMirroring()) {
                    ...
                    canvas.scale(-1.0f, BaseField.BORDER_WIDTH_THIN);
                }
