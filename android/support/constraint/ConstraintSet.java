...
public class ConstraintSet {
    ...
    private static class Constraint {
        ...
        private Constraint() {
            ...
            this.alpha = BaseField.BORDER_WIDTH_THIN;
            this.applyElevation = false;
            this.elevation = 0.0f;
            this.rotationX = 0.0f;
            this.rotationY = 0.0f;
            this.scaleX = BaseField.BORDER_WIDTH_THIN;
            this.scaleY = BaseField.BORDER_WIDTH_THIN;
    ...
    public void center(int centerID, int firstID, int firstSide, int firstMargin, int secondId, int secondSide, int secondMargin, float bias) {
        if (firstMargin < 0) {
            ...
            throw new IllegalArgumentException("margin must be > 0");
        } else if (bias <= 0.0f || bias > BaseField.BORDER_WIDTH_THIN) {
