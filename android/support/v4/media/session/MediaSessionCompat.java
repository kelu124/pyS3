...
public class MediaSessionCompat {
    ...
    class C01811 extends Callback {
        C01811() {
        }
    }

    class C01822 extends Callback {
        C01822() {
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C01831();
        VolumeProviderCompat mVolumeProvider;
        int mVolumeType;

        class C01831 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C01831() {
            }
        ...
        class C01842 implements Callback {
            C01842() {
            }
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C01851();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        static class C01851 implements Creator<QueueItem> {
            C01851() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C01861();
        private ResultReceiver mResultReceiver;

        static class C01861 implements Creator<ResultReceiverWrapper> {
            C01861() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C01871();
        private final Object mInner;

        static class C01871 implements Creator<Token> {
            C01871() {
            }
