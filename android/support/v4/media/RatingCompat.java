...
public final class RatingCompat implements Parcelable {
    public static final Creator<RatingCompat> CREATOR = new C01661();
    ...
    static class C01661 implements Creator<RatingCompat> {
        C01661() {
        }
    ...
    public static RatingCompat newHeartRating(boolean hasHeart) {
        return new RatingCompat(1, hasHeart ? BaseField.BORDER_WIDTH_THIN : 0.0f);
    }

    public static RatingCompat newThumbRating(boolean thumbIsUp) {
        return new RatingCompat(2, thumbIsUp ? BaseField.BORDER_WIDTH_THIN : 0.0f);
    }
    ...
    public static RatingCompat newStarRating(int starRatingStyle, float starRating) {
        ...
        switch (starRatingStyle) {
            case 3:
                maxRating = BaseField.BORDER_WIDTH_THICK;
                break;
            case 4:
                maxRating = 4.0f;
                break;
    ...
    public boolean hasHeart() {
        ...
        if (this.mRatingValue != BaseField.BORDER_WIDTH_THIN) {
            z = false;
        }
        return z;
    }
    ...
    public boolean isThumbUp() {
        if (this.mRatingStyle == 2 && this.mRatingValue == BaseField.BORDER_WIDTH_THIN) {
            return true;
        }
        return false;
    }
