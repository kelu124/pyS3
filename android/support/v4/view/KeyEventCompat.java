...
public final class KeyEventCompat {
    ...
    static class BaseKeyEventVersionImpl implements KeyEventVersionImpl {
        ...
        public int normalizeMetaState(int metaState) {
            ...
            return metaState & MetaDo.META_CREATEPALETTE;
        }

        public boolean metaStateHasModifiers(int metaState, int modifiers) {
            if (metaStateFilterDirectionalModifiers(metaStateFilterDirectionalModifiers(normalizeMetaState(metaState) & MetaDo.META_CREATEPALETTE, modifiers, 1, 64, 128), modifiers, 2, 16, 32) == modifiers) {
                return true;
            }
            return false;
        }
        ...
        public boolean metaStateHasNoModifiers(int metaState) {
            return (normalizeMetaState(metaState) & MetaDo.META_CREATEPALETTE) == 0;
        }
