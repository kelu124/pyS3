...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attrs) {
        ...
        this.mIndicatorHeight = (int) ((BaseField.BORDER_WIDTH_THICK * density) + 0.5f);
        ...
        this.mFullUnderlineHeight = (int) ((BaseField.BORDER_WIDTH_THIN * density) + 0.5f);
        ...
        this.mPrevText.setOnClickListener(new C02131());
        this.mNextText.setFocusable(true);
        this.mNextText.setOnClickListener(new C02142());
    ...
    void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        this.mTabAlpha = (int) ((Math.abs(positionOffset - 0.5f) * BaseField.BORDER_WIDTH_MEDIUM) * 255.0f);
