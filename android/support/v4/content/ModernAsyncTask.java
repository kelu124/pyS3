...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C01271();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C01282();

    static class C01271 implements ThreadFactory {
    ...
    class C01282 extends WorkerRunnable<Params, Result> {
        C01282() {
        }
