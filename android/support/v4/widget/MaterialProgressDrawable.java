...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private final Callback mCallback = new C02403();
    boolean mFinishing;
    ...
    class C02403 implements Callback {
        C02403() {
        }
    ...
    private static class Ring {
        ...
        private void drawTriangle(Canvas c, float startAngle, float sweepAngle, Rect bounds) {
            if (this.mShowArrow) {
                ...
                this.mArrow.lineTo((((float) this.mArrowWidth) * this.mArrowScale) / BaseField.BORDER_WIDTH_MEDIUM, ((float) this.mArrowHeight) * this.mArrowScale);
        ...
        public void setInsets(int width, int height) {
            ...
            if (this.mRingCenterRadius <= 0.0d || minEdge < 0.0f) {
                insets = (float) Math.ceil((double) (this.mStrokeWidth / BaseField.BORDER_WIDTH_MEDIUM));
            } else {
                insets = (float) (((double) (minEdge / BaseField.BORDER_WIDTH_MEDIUM)) - this.mRingCenterRadius);
            }
    ...
    public void updateSizes(int size) {
        if (size == 0) {
            setSizeParameters(56.0d, 56.0d, 12.5d, 3.0d, HtmlUtilities.DEFAULT_FONT_SIZE, 6.0f);
        } else {
    ...
    float getMinProgressArc(Ring ring) {
        return (float) Math.toRadians(((double) ring.getStrokeWidth()) / (opencv_core.CV_2PI * ring.getCenterRadius()));
    }
    ...
    private void setupAnimators() {
        ...
        animation.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationRepeat(Animation animation) {
                ...
                MaterialProgressDrawable.this.mRotationCount = (MaterialProgressDrawable.this.mRotationCount + BaseField.BORDER_WIDTH_THIN) % 5.0f;
            }
        });
