...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C02471 implements AnimationListener {
        C02471() {
        }
    ...
    class C02482 extends Animation {
        C02482() {
        }
    ...
    class C02493 extends Animation {
        C02493() {
        }

        public void applyTransformation(float interpolatedTime, Transformation t) {
            SwipeRefreshLayout.this.setAnimationProgress(BaseField.BORDER_WIDTH_THIN - interpolatedTime);
        }
    }

    class C02515 implements AnimationListener {
        C02515() {
        }
    ...
    class C02526 extends Animation {
        C02526() {
        }
        ...
        public void applyTransformation(float interpolatedTime, Transformation t) {
            ...
            SwipeRefreshLayout.this.mProgress.setArrowScale(BaseField.BORDER_WIDTH_THIN - interpolatedTime);
        }
    }

    class C02537 extends Animation {
        C02537() {
        }
    ...
    class C02548 extends Animation {
        C02548() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mRefreshListener = new C02471();
        this.mAnimateToCorrectPosition = new C02526();
        this.mAnimateToStartPosition = new C02537();
        ...
        moveToStart(BaseField.BORDER_WIDTH_THIN);
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C02482();
    ...
    void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C02493();
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        float dragPercent = Math.min(BaseField.BORDER_WIDTH_THIN, Math.abs(overscrollTop / this.mTotalDragDistance));
        float adjustedPercent = (((float) Math.max(((double) dragPercent) - 0.4d, 0.0d)) * 5.0f) / BaseField.BORDER_WIDTH_THICK;
        ...
        if (!this.mScale) {
            ViewCompat.setScaleX(this.mCircleView, BaseField.BORDER_WIDTH_THIN);
            ViewCompat.setScaleY(this.mCircleView, BaseField.BORDER_WIDTH_THIN);
        }
        if (this.mScale) {
            setAnimationProgress(Math.min(BaseField.BORDER_WIDTH_THIN, overscrollTop / this.mTotalDragDistance));
        }
        ...
        this.mProgress.setArrowScale(Math.min(BaseField.BORDER_WIDTH_THIN, adjustedPercent));
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C02548();
