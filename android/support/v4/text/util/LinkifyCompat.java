...
public final class LinkifyCompat {
    private static final Comparator<LinkSpec> COMPARATOR = new C02021();
    private static final String[] EMPTY_STRING = new String[0];

    static class C02021 implements Comparator<LinkSpec> {
        C02021() {
        }
        ...
        while (true) {
            ...
            if (address != null) {
                ...
                if (start >= 0) {
                    ...
                    try {
                        spec.url = "geo:0,0?q=" + URLEncoder.encode(address, XmpWriter.UTF8);
                        links.add(spec);
