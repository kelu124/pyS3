...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    static final Interpolator ACCELERATE_QUINT = new AccelerateInterpolator(PdfWriter.SPACE_CHAR_RATIO_DEFAULT);
    ...
    static final Interpolator DECELERATE_QUINT = new DecelerateInterpolator(PdfWriter.SPACE_CHAR_RATIO_DEFAULT);
    ...
    int mCurState = 0;
    boolean mDestroyed;
    Runnable mExecCommit = new C01041();
...
*/
    ...
    Animation loadAnimation(Fragment fragment, int transit, boolean enter, int transitionStyle) {
        ...
        switch (styleIndex) {
            case 1:
                return makeOpenCloseAnimation(this.mHost.getContext(), 1.125f, BaseField.BORDER_WIDTH_THIN, 0.0f, BaseField.BORDER_WIDTH_THIN);
            case 2:
                return makeOpenCloseAnimation(this.mHost.getContext(), BaseField.BORDER_WIDTH_THIN, 0.975f, BaseField.BORDER_WIDTH_THIN, 0.0f);
            case 3:
                return makeOpenCloseAnimation(this.mHost.getContext(), 0.975f, BaseField.BORDER_WIDTH_THIN, 0.0f, BaseField.BORDER_WIDTH_THIN);
            case 4:
                return makeOpenCloseAnimation(this.mHost.getContext(), BaseField.BORDER_WIDTH_THIN, 1.075f, BaseField.BORDER_WIDTH_THIN, 0.0f);
            case 5:
                return makeFadeAnimation(this.mHost.getContext(), 0.0f, BaseField.BORDER_WIDTH_THIN);
            case 6:
                return makeFadeAnimation(this.mHost.getContext(), BaseField.BORDER_WIDTH_THIN, 0.0f);
            default:
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        String fname = attrs.getAttributeValue(null, HtmlTags.CLASS);
