    ...
    private static ColorStateList inflate(@NonNull Resources r, @NonNull XmlPullParser parser, @NonNull AttributeSet attrs, @Nullable Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (depth < innerDepth && type == 3) {
                ...
                TypedArray a = obtainAttributes(r, theme, attrs, C0284R.styleable.ColorStateListItem);
                int baseColor = a.getColor(C0284R.styleable.ColorStateListItem_android_color, -65281);
                float alphaMod = BaseField.BORDER_WIDTH_THIN;
                if (a.hasValue(C0284R.styleable.ColorStateListItem_android_alpha)) {
                    alphaMod = a.getFloat(C0284R.styleable.ColorStateListItem_android_alpha, BaseField.BORDER_WIDTH_THIN);
                } else if (a.hasValue(C0284R.styleable.ColorStateListItem_alpha)) {
                    alphaMod = a.getFloat(C0284R.styleable.ColorStateListItem_alpha, BaseField.BORDER_WIDTH_THIN);
                }
                a.recycle();
                ...
                while (i < numAttrs) {
                    ...
                    if (stateResId == 16843173 || stateResId == 16843551 || stateResId == C0284R.attr.alpha) {
                        j2 = j;
                    } else {
                        j2 = j + 1;
