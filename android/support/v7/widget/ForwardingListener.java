...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C03261 implements OnAttachStateChangeListener {
        C03261() {
        }
    ...
    class C03272 implements OnGlobalLayoutListener {
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C03261());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C03272());
    }
