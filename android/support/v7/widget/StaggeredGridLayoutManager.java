...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    private final Runnable mCheckForGapsRunnable = new C03721();
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C03731();
            int mGapDir;
            int[] mGapPerSpan;
            boolean mHasUnwantedGapAfter;
            int mPosition;

            static class C03731 implements Creator<FullSpanItem> {
                C03731() {
                }
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C03741();
        ...
        static class C03741 implements Creator<SavedState> {
            C03741() {
            }
            ...
            for (i = 0; i < childCount; i++) {
                ...
                if (size >= maxSize) {
                    if (((LayoutParams) child.getLayoutParams()).isFullSpan()) {
                        size = (BaseField.BORDER_WIDTH_THIN * size) / ((float) this.mSpanCount);
                    }
