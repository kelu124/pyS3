...
import android.support.v7.recyclerview.C0286R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static final Interpolator sQuinticInterpolator = new C03513();
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C03551();
        ...
        private final Callback mVerticalBoundCheckCallback = new C03562();
        private int mWidth;
        ...
        class C03551 implements Callback {
            C03551() {
            }
        ...
        class C03562 implements Callback {
            C03562() {
            }
        ...
        public boolean isViewPartiallyVisible(@NonNull View child, boolean completelyVisible, boolean acceptEndPointInclusion) {
            ...
            boolean z = true;
            if (this.mHorizontalBoundCheck.isViewWithinBoundFlags(child, ProbeMessageID.ID_SET_BBP_DELTA_PHASE) && this.mVerticalBoundCheck.isViewWithinBoundFlags(child, ProbeMessageID.ID_SET_BBP_DELTA_PHASE)) {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0286R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0286R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0286R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0286R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0286R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    static class C03513 implements Interpolator {
        C03513() {
        }

        public float getInterpolation(float t) {
            t -= BaseField.BORDER_WIDTH_THIN;
            return ((((t * t) * t) * t) * t) + BaseField.BORDER_WIDTH_THIN;
        }
    }

    class C03524 implements ProcessCallback {
        C03524() {
        }
    ...
    class C03535 implements Callback {
        C03535() {
        }
    ...
    class C03546 implements Callback {
        C03546() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03571());
        Parcelable mLayoutState;

        static class C03571 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03571() {
            }
    ...
    class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int dx, int dy, int vx, int vy) {
            ...
            float distance = ((float) halfContainerSize) + (((float) halfContainerSize) * distanceInfluenceForSnapDuration(Math.min(BaseField.BORDER_WIDTH_THIN, (BaseField.BORDER_WIDTH_THIN * ((float) delta)) / ((float) containerSize))));
            if (velocity > 0) {
                ...
                duration = (int) (((((float) absDx) / ((float) containerSize)) + BaseField.BORDER_WIDTH_THIN) * 300.0f);
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C03491();
        ...
        this.mItemAnimatorRunner = new C03502();
        this.mViewInfoProcessCallback = new C03524();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0286R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0286R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0286R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03535());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03546());
    }
    ...
    private void pullGlows(float x, float overscrollX, float y, float overscrollY) {
        ...
        if (overscrollX < 0.0f) {
            ensureLeftGlow();
            if (this.mLeftGlow.onPull((-overscrollX) / ((float) getWidth()), BaseField.BORDER_WIDTH_THIN - (y / ((float) getHeight())))) {
                invalidate = true;
            }
        ...
        if (overscrollY < 0.0f) {
            ...
            ensureBottomGlow();
            if (this.mBottomGlow.onPull(overscrollY / ((float) getHeight()), BaseField.BORDER_WIDTH_THIN - (x / ((float) getWidth())))) {
                invalidate = true;
            }
        }
