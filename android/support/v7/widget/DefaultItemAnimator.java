...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new VpaListenerAdapter() {
            ...
            public void onAnimationEnd(View view) {
                ...
                ViewCompat.setAlpha(view, BaseField.BORDER_WIDTH_THIN);
    ...
    void animateAddImpl(final ViewHolder holder) {
        ...
        animation.alpha(BaseField.BORDER_WIDTH_THIN).setDuration(getAddDuration()).setListener(new VpaListenerAdapter() {
            public void onAnimationStart(View view) {
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(BaseField.BORDER_WIDTH_THIN).setListener(new VpaListenerAdapter() {
                public void onAnimationStart(View view) {
                ...
                public void onAnimationEnd(View view) {
                    ...
                    ViewCompat.setAlpha(newView, BaseField.BORDER_WIDTH_THIN);
    ...
    private boolean endChangeAnimationIfNecessary(ChangeInfo changeInfo, ViewHolder item) {
        ...
        ViewCompat.setAlpha(item.itemView, BaseField.BORDER_WIDTH_THIN);
    ...
    public void endAnimations() {
        ...
        for (i = this.mPendingAdditions.size() - 1; i >= 0; i--) {
            ...
            ViewCompat.setAlpha(item2.itemView, BaseField.BORDER_WIDTH_THIN);
