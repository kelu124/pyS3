...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0284R.attr.actionBarSize, 16842841};
    ...
    class C03041 extends ViewPropertyAnimatorListenerAdapter {
        C03041() {
        }
    ...
    class C03063 implements Runnable {
        C03063() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C03041();
        this.mRemoveActionBarHideOffset = new C03052();
        this.mAddActionBarHideOffset = new C03063();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0284R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0284R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0284R.id.action_bar));
        }
    }
