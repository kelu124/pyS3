...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attrs) {
        this(context, attrs, C0284R.attr.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0284R.styleable.SwitchCompat, defStyleAttr, 0);
        this.mThumbDrawable = a.getDrawable(C0284R.styleable.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = a.getDrawable(C0284R.styleable.SwitchCompat_track);
        if (this.mTrackDrawable != null) {
            this.mTrackDrawable.setCallback(this);
        }
        this.mTextOn = a.getText(C0284R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = a.getText(C0284R.styleable.SwitchCompat_android_textOff);
        this.mShowText = a.getBoolean(C0284R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = a.getDimensionPixelSize(C0284R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = a.getDimensionPixelSize(C0284R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = a.getDimensionPixelSize(C0284R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = a.getBoolean(C0284R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList thumbTintList = a.getColorStateList(C0284R.styleable.SwitchCompat_thumbTint);
        if (thumbTintList != null) {
            this.mThumbTintList = thumbTintList;
            this.mHasThumbTint = true;
        }
        Mode thumbTintMode = DrawableUtils.parseTintMode(a.getInt(C0284R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        ColorStateList trackTintList = a.getColorStateList(C0284R.styleable.SwitchCompat_trackTint);
        if (trackTintList != null) {
            this.mTrackTintList = trackTintList;
            this.mHasTrackTint = true;
        }
        Mode trackTintMode = DrawableUtils.parseTintMode(a.getInt(C0284R.styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        int appearance = a.getResourceId(C0284R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (appearance != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        TintTypedArray appearance = TintTypedArray.obtainStyledAttributes(context, resid, C0284R.styleable.TextAppearance);
        ColorStateList colors = appearance.getColorStateList(C0284R.styleable.TextAppearance_android_textColor);
        if (colors != null) {
            this.mTextColors = colors;
        } else {
            this.mTextColors = getTextColors();
        }
        int ts = appearance.getDimensionPixelSize(C0284R.styleable.TextAppearance_android_textSize, 0);
        if (!(ts == 0 || ((float) ts) == this.mTextPaint.getTextSize())) {
            this.mTextPaint.setTextSize((float) ts);
            requestLayout();
        }
        setSwitchTypefaceByIndex(appearance.getInt(C0284R.styleable.TextAppearance_android_typeface, -1), appearance.getInt(C0284R.styleable.TextAppearance_android_textStyle, -1));
        if (appearance.getBoolean(C0284R.styleable.TextAppearance_textAllCaps, false)) {
    ...
    private Layout makeLayout(CharSequence text) {
        ...
        return new StaticLayout(transformed, this.mTextPaint, transformed != null ? (int) Math.ceil((double) Layout.getDesiredWidth(transformed, this.mTextPaint)) : 0, Alignment.ALIGN_NORMAL, BaseField.BORDER_WIDTH_THIN, 0.0f, true);
    }
                ...
                switch (this.mTouchMode) {
                    ...
                    case 2:
                        ...
                        if (thumbScrollRange != 0) {
                            ...
                            dPos = thumbScrollOffset > 0.0f ? BaseField.BORDER_WIDTH_THIN : -1.0f;
                        }
                        if (ViewUtils.isLayoutRtl(this)) {
                            dPos = -dPos;
                        }
                        float newPos = constrain(this.mThumbPosition + dPos, 0.0f, BaseField.BORDER_WIDTH_THIN);
    ...
    private void animateThumbToCheckedState(final boolean newCheckedState) {
        ...
        this.mPositionAnimator = new ThumbAnimation(this.mThumbPosition, newCheckedState ? BaseField.BORDER_WIDTH_THIN : 0.0f);
        ...
        this.mPositionAnimator.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                if (SwitchCompat.this.mPositionAnimator == animation) {
                    SwitchCompat.this.setThumbPosition(newCheckedState ? BaseField.BORDER_WIDTH_THIN : 0.0f);
    ...
    public void setChecked(boolean checked) {
        ...
        cancelPositionAnimator();
        setThumbPosition(checked ? BaseField.BORDER_WIDTH_THIN : 0.0f);
    }
    ...
    private int getThumbOffset() {
        float thumbPosition;
        if (ViewUtils.isLayoutRtl(this)) {
            thumbPosition = BaseField.BORDER_WIDTH_THIN - this.mThumbPosition;
        } else {
    ...
    public void jumpDrawablesToCurrentState() {
        if (VERSION.SDK_INT >= 11) {
            ...
            cancelPositionAnimator();
            setThumbPosition(isChecked() ? BaseField.BORDER_WIDTH_THIN : 0.0f);
        }
    }
