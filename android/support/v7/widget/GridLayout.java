...
import android.support.v7.gridlayout.C0285R;
...
public class GridLayout extends ViewGroup {
    private static final int ALIGNMENT_MODE = C0285R.styleable.GridLayout_alignmentMode;
    public static final int ALIGN_BOUNDS = 0;
    public static final int ALIGN_MARGINS = 1;
    public static final Alignment BASELINE = new C03367();
    public static final Alignment BOTTOM = TRAILING;
    static final int CAN_STRETCH = 2;
    public static final Alignment CENTER = new C03346();
    private static final int COLUMN_COUNT = C0285R.styleable.GridLayout_columnCount;
    private static final int COLUMN_ORDER_PRESERVED = C0285R.styleable.GridLayout_columnOrderPreserved;
    ...
    public static final Alignment FILL = new C03378();
    public static final int HORIZONTAL = 0;
    static final int INFLEXIBLE = 0;
    private static final Alignment LEADING = new C03313();
    ...
    static final Printer NO_PRINTER = new C03291();
    private static final int ORIENTATION = C0285R.styleable.GridLayout_orientation;
    public static final Alignment RIGHT = createSwitchingAlignment(END, START);
    private static final int ROW_COUNT = C0285R.styleable.GridLayout_rowCount;
    private static final int ROW_ORDER_PRESERVED = C0285R.styleable.GridLayout_rowOrderPreserved;
    public static final Alignment START = LEADING;
    public static final Alignment TOP = LEADING;
    private static final Alignment TRAILING = new C03324();
    public static final int UNDEFINED = Integer.MIN_VALUE;
    static final Alignment UNDEFINED_ALIGNMENT = new C03302();
    static final int UNINITIALIZED_HASH = 0;
    private static final int USE_DEFAULT_MARGINS = C0285R.styleable.GridLayout_useDefaultMargins;
    ...
    static class C03291 implements Printer {
        C03291() {
        }
    ...
    static class C03302 extends Alignment {
        C03302() {
        }
    ...
    static class C03313 extends Alignment {
        C03313() {
        }
    ...
    static class C03324 extends Alignment {
        C03324() {
        }
    ...
    static class C03346 extends Alignment {
        C03346() {
        }
    ...
    static class C03367 extends Alignment {

        class C03351 extends Bounds {
            private int size;
    ...
    static class C03378 extends Alignment {
        C03378() {
        }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        private static final int BOTTOM_MARGIN = C0285R.styleable.GridLayout_Layout_android_layout_marginBottom;
        private static final int COLUMN = C0285R.styleable.GridLayout_Layout_layout_column;
        private static final int COLUMN_SPAN = C0285R.styleable.GridLayout_Layout_layout_columnSpan;
        private static final int COLUMN_WEIGHT = C0285R.styleable.GridLayout_Layout_layout_columnWeight;
        ...
        private static final int GRAVITY = C0285R.styleable.GridLayout_Layout_layout_gravity;
        private static final int LEFT_MARGIN = C0285R.styleable.GridLayout_Layout_android_layout_marginLeft;
        private static final int MARGIN = C0285R.styleable.GridLayout_Layout_android_layout_margin;
        private static final int RIGHT_MARGIN = C0285R.styleable.GridLayout_Layout_android_layout_marginRight;
        private static final int ROW = C0285R.styleable.GridLayout_Layout_layout_row;
        private static final int ROW_SPAN = C0285R.styleable.GridLayout_Layout_layout_rowSpan;
        private static final int ROW_WEIGHT = C0285R.styleable.GridLayout_Layout_layout_rowWeight;
        private static final int TOP_MARGIN = C0285R.styleable.GridLayout_Layout_android_layout_marginTop;
        ...
        private void reInitSuper(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0285R.styleable.GridLayout_Layout);
            try {
    ...
    public GridLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mDefaultGap = context.getResources().getDimensionPixelOffset(C0285R.dimen.default_gap);
        TypedArray a = context.obtainStyledAttributes(attrs, C0285R.styleable.GridLayout);
        try {
