...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(C0284R.attr.actionBarPopupTheme, tv, true) || tv.resourceId == 0) {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0284R.styleable.ActionBar, C0284R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0284R.styleable.ActionBar_height, 0));
        a.recycle();
