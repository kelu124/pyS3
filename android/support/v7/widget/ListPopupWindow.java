...
public class ListPopupWindow implements ShowableListMenu {
    ...
    class C03423 implements OnItemSelectedListener {
        C03423() {
        }
    ...
    public ListPopupWindow(@NonNull Context context) {
        this(context, null, C0284R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0284R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0284R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0284R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, 0);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0284R.styleable.ListPopupWindow_android_dropDownVerticalOffset, 0);
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C03412();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C03423());
            ...
            if (hintView != null) {
                ...
                hintParams = new LayoutParams(-1, 0, BaseField.BORDER_WIDTH_THIN);
