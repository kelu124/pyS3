...
class TwilightCalculator {
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        double solarLng = (1.796593063d + (((((double) meanAnomaly) + (0.03341960161924362d * Math.sin((double) meanAnomaly))) + (3.4906598739326E-4d * Math.sin((double) (BaseField.BORDER_WIDTH_MEDIUM * meanAnomaly)))) + (5.236000106378924E-6d * Math.sin((double) (BaseField.BORDER_WIDTH_THICK * meanAnomaly))))) + 3.141592653589793d;
        ...
        if (cosHourAngle >= 1.0d) {
            ...
            float hourAngle = (float) (Math.acos(cosHourAngle) / opencv_core.CV_2PI);
