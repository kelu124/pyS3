...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02811();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02822();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02833();
    ...
    class C02822 extends ViewPropertyAnimatorListenerAdapter {
        C02822() {
        }
    ...
    class C02833 implements ViewPropertyAnimatorUpdateListener {
        C02833() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0284R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0284R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0284R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0284R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0284R.styleable.ActionBar, C0284R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0284R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0284R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public void doShow(boolean fromSystem) {
        ...
        if (this.mCurWindowVisibility == 0 && ALLOW_SHOW_HIDE_ANIMATIONS && (this.mShowHideAnimationEnabled || fromSystem)) {
            ...
            ViewCompat.setAlpha(this.mContainerView, BaseField.BORDER_WIDTH_THIN);
            ViewCompat.setTranslationY(this.mContainerView, 0.0f);
            if (this.mContentAnimations && this.mContentView != null) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0284R.attr.actionBarWidgetTheme, outValue, true);
