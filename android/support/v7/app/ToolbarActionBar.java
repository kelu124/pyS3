...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C02802();
    private final Runnable mMenuInvalidator = new C02791();
    ...
    class C02802 implements OnMenuItemClickListener {
        C02802() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0284R.layout.abc_list_menu_item_layout);
