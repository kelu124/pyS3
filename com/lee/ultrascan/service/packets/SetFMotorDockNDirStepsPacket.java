...
public class SetFMotorDockNDirStepsPacket extends Packet {
    private final short steps;

    public SetFMotorDockNDirStepsPacket(short steps) {
        super(new PacketHeader(ProbeMessageID.ID_SET_FMOTOR_DOCK_NDIR_STEPS, 2));
        this.steps = steps;
    }
