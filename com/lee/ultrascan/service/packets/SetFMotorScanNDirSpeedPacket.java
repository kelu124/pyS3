...
public class SetFMotorScanNDirSpeedPacket extends Packet {
    private final short freqCoe;

    public SetFMotorScanNDirSpeedPacket(short freqCoe) {
        super(new PacketHeader(ProbeMessageID.ID_SET_FMOTOR_SCAN_NDIR_SPEED, 2));
