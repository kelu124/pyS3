...
public class XMPSerializerRDF {
    ...
    private boolean canBeRDFAttrProp(XMPNode node) {
        return (node.hasQualifier() || node.getOptions().isURI() || node.getOptions().isCompositeProperty() || node.getOptions().containsOneOf(1073741824) || XMPConst.ARRAY_ITEM_NAME.equals(node.getName())) ? false : true;
    }
