...
public final class Multimaps {
    ...
    static final class AsMap<K, V> extends ViewCachingAbstractMap<K, Collection<V>> {
        ...
        class EntrySet extends EntrySet<K, Collection<V>> {
            ...
            class C05951 implements Function<K, Collection<V>> {
                C05951() {
                }
            ...
            public Iterator<Entry<K, Collection<V>>> iterator() {
                return Maps.asMapEntryIterator(AsMap.this.multimap.keySet(), new C05951());
            }
    ...
    private static class MapMultimap<K, V> extends AbstractMultimap<K, V> implements SetMultimap<K, V>, Serializable {
        ...
        public Set<V> get(final K key) {
            return new ImprovedAbstractSet<V>() {
                ...
                class C05981 implements Iterator<V> {
                    int f24i;
                    ...
                    public boolean hasNext() {
                        return this.f24i == 0 && MapMultimap.this.map.containsKey(key);
                    }
    ...
    private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        class C06001 implements EntryTransformer<K, Collection<V1>, Collection<V2>> {
            C06001() {
            }
        ...
        Map<K, Collection<V2>> createAsMap() {
            return Maps.transformEntries(this.fromMultimap.asMap(), new C06001());
        }
    ...
    private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
        ...
        class C06011 implements Function<Collection<V>, Collection<V>> {
            C06011() {
            }
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            result = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new C06011()));
            this.map = result;
            return result;
        }
