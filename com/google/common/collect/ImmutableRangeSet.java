...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    private final class AsSet extends ImmutableSortedSet<C> {
        ...
        class C05231 extends AbstractIterator<C> {
        ...
        class C05242 extends AbstractIterator<C> {
            Iterator<C> elemItr = Iterators.emptyIterator();
        ...
        public int size() {
            ...
            if (result == null) {
                ...
                while (i$.hasNext()) {
                    total += (long) ContiguousSet.create((Range) i$.next(), this.domain).size();
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        public Builder<C> add(Range<C> range) {
            if (range.isEmpty()) {
                ...
                for (Object currentRange : this.rangeSet.asRanges()) {
                    boolean z = !currentRange.isConnected(range) || currentRange.intersection(range).isEmpty();
                    Preconditions.checkArgument(z, "Ranges may not overlap, but received %s and %s", currentRange, (Object) range);
                }
    ...
    public boolean intersects(Range<C> otherRange) {
        int ceilingIndex = SortedLists.binarySearch(this.ranges, Range.lowerBoundFn(), otherRange.lowerBound, Ordering.natural(), KeyPresentBehavior.ANY_PRESENT, KeyAbsentBehavior.NEXT_HIGHER);
        ...
        boolean z = ceilingIndex > 0 && ((Range) this.ranges.get(ceilingIndex - 1)).isConnected(otherRange) && !((Range) this.ranges.get(ceilingIndex - 1)).intersection(otherRange).isEmpty();
        return z;
    }
