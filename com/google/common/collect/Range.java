...
public final class Range<C extends Comparable> implements Predicate<C>, Serializable {
    ...
    private static final Function<Range, Cut> LOWER_BOUND_FN = new C06141();
    static final Ordering<Range<?>> RANGE_LEX_ORDERING = new RangeLexOrdering();
    private static final Function<Range, Cut> UPPER_BOUND_FN = new C06152();
    private static final long serialVersionUID = 0;
    final Cut<C> lowerBound;
    final Cut<C> upperBound;

    static class C06141 implements Function<Range, Cut> {
        C06141() {
        }
    ...
    static class C06152 implements Function<Range, Cut> {
        C06152() {
        }
