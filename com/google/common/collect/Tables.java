...
public final class Tables {
    private static final Function<? extends Map<?, ?>, ? extends Map<?, ?>> UNMODIFIABLE_WRAPPER = new C06511();
    ...
    static class C06511 implements Function<Map<Object, Object>, Map<Object, Object>> {
        C06511() {
        }
    ...
    private static class TransformedTable<R, C, V1, V2> extends AbstractTable<R, C, V2> {
        ...
        class C06521 implements Function<Cell<R, C, V1>, Cell<R, C, V2>> {
            C06521() {
            }
        ...
        class C06532 implements Function<Map<C, V1>, Map<C, V2>> {
            C06532() {
            }
        ...
        class C06543 implements Function<Map<R, V1>, Map<R, V2>> {
            C06543() {
            }
        ...
        public Map<R, Map<C, V2>> rowMap() {
            return Maps.transformValues(this.fromTable.rowMap(), new C06532());
        }

        public Map<C, Map<R, V2>> columnMap() {
            return Maps.transformValues(this.fromTable.columnMap(), new C06543());
        }
    }

    private static class TransposeTable<C, R, V> extends AbstractTable<C, R, V> {
        private static final Function<Cell<?, ?, ?>, Cell<?, ?, ?>> TRANSPOSE_CELL = new C06551();
        final Table<R, C, V> original;

        static class C06551 implements Function<Cell<?, ?, ?>, Cell<?, ?, ?>> {
            C06551() {
            }
