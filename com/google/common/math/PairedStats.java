...
public final class PairedStats implements Serializable {
    ...
    public String toString() {
        if (count() > 0) {
            return MoreObjects.toStringHelper((Object) this).add("xStats", this.xStats).add("yStats", this.yStats).add("populationCovariance", populationCovariance()).toString();
        }
        return MoreObjects.toStringHelper((Object) this).add("xStats", this.xStats).add("yStats", this.yStats).toString();
    }
    ...
    private static double ensurePositive(double value) {
        return value > 0.0d ? value : Double.MIN_VALUE;
    }
