...
public final class ElementOrder<T> {
    ...
    private ElementOrder(Type type, @Nullable Comparator<T> comparator) {
        ...
        Preconditions.checkState(obj == (comparator != null ? 1 : null));
    }
    ...
    public String toString() {
        ToStringHelper helper = MoreObjects.toStringHelper((Object) this).add(DublinCoreProperties.TYPE, this.type);
        if (this.comparator != null) {
