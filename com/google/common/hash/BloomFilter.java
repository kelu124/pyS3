...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
    ...
    private BloomFilter(BitArray bits, int numHashFunctions, Funnel<? super T> funnel, Strategy strategy) {
        ...
        Preconditions.checkArgument(z, "numHashFunctions (%s) must be <= 255", numHashFunctions);
    ...
    public void putAll(BloomFilter<T> that) {
        ...
        Preconditions.checkArgument(z, "BloomFilters must have the same size underlying bit arrays (%s != %s)", bitSize(), that.bitSize());
