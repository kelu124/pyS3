...
public final class Resources {
    ...
    static class C07531 implements LineProcessor<List<String>> {
    ...
    public static List<String> readLines(URL url, Charset charset) throws IOException {
        return (List) readLines(url, charset, new C07531());
    }
    ...
    public static URL getResource(Class<?> contextClass, String resourceName) {
        ...
        Preconditions.checkArgument(url != null, "resource %s relative to %s not found.", (Object) resourceName, contextClass.getName());
        return url;
    }
}
