...
final class Types {
    ...
    private static final Function<Type, String> TYPE_NAME = new C07831();

    static class C07831 implements Function<Type, String> {
        C07831() {
        }
    ...
    private enum ClassOwnership {
        ...
        static class C07873 extends AnonymousClass1LocalClass<String> {
            C07873() {
            }
        }
        ...
        private static ClassOwnership detectJvmBehavior() {
            ParameterizedType parameterizedType = (ParameterizedType) new C07873().getClass().getGenericSuperclass();
    ...
    enum JavaVersion {
        ...
        static class C07914 extends TypeCapture<int[]> {
            C07914() {
            }
        }
    ...
    static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public String toString() {
            ...
            while (i$.hasNext()) {
                builder.append(" super ").append(JavaVersion.CURRENT.typeName((Type) i$.next()));
            }
    ...
    private static void disallowPrimitiveType(Type[] types, String usedAs) {
        for (Type type : types) {
            if (type instanceof Class) {
                Object cls = (Class) type;
                Preconditions.checkArgument(!cls.isPrimitive(), "Primitive type '%s' used as %s", cls, (Object) usedAs);
            }
        }
    }
