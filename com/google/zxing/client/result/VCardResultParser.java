...
import com.uuzuche.lib_zxing.decoding.Intents.WifiConnect;
...
public final class VCardResultParser extends ResultParser {
            ...
            if (metadataString != null) {
                for (String metadatum : SEMICOLON.split(metadataString)) {
                    ...
                    if (metadatumTokens.length > 1) {
                        ...
                        if (Chunk.ENCODING.equalsIgnoreCase(key) && "QUOTED-PRINTABLE".equalsIgnoreCase(value)) {
    ...
    private static void maybeAppendFragment(ByteArrayOutputStream fragmentBuffer, String charset, StringBuilder result) {
        if (fragmentBuffer.size() > 0) {
            ...
            if (charset == null) {
                fragment = new String(fragmentBytes, Charset.forName(XmpWriter.UTF8));
            } else {
                try {
