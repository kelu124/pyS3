...
public final class Decoder {
    ...
    private static final String[] LOWER_TABLE = new String[]{"CTRL_PS", " ", HtmlTags.f32A, HtmlTags.f33B, "c", "d", "e", "f", "g", "h", "i", Complex.SUPPORTED_SUFFIX, "k", "l", "m", "n", "o", HtmlTags.f35P, "q", "r", HtmlTags.f36S, "t", HtmlTags.f37U, "v", "w", "x", "y", "z", "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
