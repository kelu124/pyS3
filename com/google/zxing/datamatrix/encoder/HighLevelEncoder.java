...
public final class HighLevelEncoder {
    ...
    static int lookAheadTest(CharSequence msg, int startpos, int currentMode) {
        ...
        int minCount;
        if (currentMode == 0) {
            charCounts = new float[]{0.0f, BaseField.BORDER_WIDTH_THIN, BaseField.BORDER_WIDTH_THIN, BaseField.BORDER_WIDTH_THIN, BaseField.BORDER_WIDTH_THIN, 1.25f};
        } else {
            charCounts = new float[]{BaseField.BORDER_WIDTH_THIN, BaseField.BORDER_WIDTH_MEDIUM, BaseField.BORDER_WIDTH_MEDIUM, BaseField.BORDER_WIDTH_MEDIUM, BaseField.BORDER_WIDTH_MEDIUM, 2.25f};
        ...
        while (startpos + charsProcessed != msg.length()) {
            ...
            if (isDigit(c)) {
                ...
                charCounts[0] = charCounts[0] + BaseField.BORDER_WIDTH_MEDIUM;
            } else {
                charCounts[0] = (float) ((int) Math.ceil((double) charCounts[0]));
                charCounts[0] = charCounts[0] + BaseField.BORDER_WIDTH_THIN;
            }
            if (isNativeC40(c)) {
            ...
            if (isSpecialB256(c)) {
                ...
                charCounts[5] = charCounts[5] + BaseField.BORDER_WIDTH_THIN;
            }
            if (charsProcessed >= 4) {
