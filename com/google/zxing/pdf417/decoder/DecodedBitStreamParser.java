...
final class DecodedBitStreamParser {
    private static /* synthetic */ int[] f75xca07ee0 = null;
    ...
    private static final char[] MIXED_CHARS = new char[]{'0', '1', PdfWriter.VERSION_1_2, PdfWriter.VERSION_1_3, PdfWriter.VERSION_1_4, PdfWriter.VERSION_1_5, PdfWriter.VERSION_1_6, PdfWriter.VERSION_1_7, '8', '9', '&', '\r', '\t', ',', ':', '#', '-', '.', '$', '/', '+', '%', '*', '=', '^'};
    ...
    static /* synthetic */ int[] m196xca07ee0() {
        int[] iArr = f75xca07ee0;
        if (iArr == null) {
    ...
    private static void decodeTextCompaction(int[] textCompactionData, int[] byteCompactionData, int length, StringBuilder result) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            char ch = '\u0000';
            switch (m196xca07ee0()[subMode.ordinal()]) {
                case 1:
                    if (subModeCh >= 26) {
                        if (subModeCh != 26) {
                            if (subModeCh != 27) {
