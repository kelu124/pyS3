...
public final class WhiteRectangleDetector {
    ...
    private ResultPoint[] centerEdges(ResultPoint y, ResultPoint z, ResultPoint x, ResultPoint t) {
        ...
        float ti = t.getX();
        float tj = t.getY();
        if (yi < ((float) this.width) / BaseField.BORDER_WIDTH_MEDIUM) {
            return new ResultPoint[]{new ResultPoint(ti - BaseField.BORDER_WIDTH_THIN, BaseField.BORDER_WIDTH_THIN + tj), new ResultPoint(BaseField.BORDER_WIDTH_THIN + zi, BaseField.BORDER_WIDTH_THIN + zj), new ResultPoint(xi - BaseField.BORDER_WIDTH_THIN, xj - BaseField.BORDER_WIDTH_THIN), new ResultPoint(BaseField.BORDER_WIDTH_THIN + yi, yj - BaseField.BORDER_WIDTH_THIN)};
        }
        return new ResultPoint[]{new ResultPoint(BaseField.BORDER_WIDTH_THIN + ti, BaseField.BORDER_WIDTH_THIN + tj), new ResultPoint(BaseField.BORDER_WIDTH_THIN + zi, zj - BaseField.BORDER_WIDTH_THIN), new ResultPoint(xi - BaseField.BORDER_WIDTH_THIN, BaseField.BORDER_WIDTH_THIN + xj), new ResultPoint(yi - BaseField.BORDER_WIDTH_THIN, yj - BaseField.BORDER_WIDTH_THIN)};
    }
