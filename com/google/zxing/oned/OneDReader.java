        ...
        try {
            ...
            if (tryHarder && image.isRotateSupported()) {
                ...
                if (metadata != null && metadata.containsKey(ResultMetadataType.ORIENTATION)) {
                    orientation = (((Integer) metadata.get(ResultMetadataType.ORIENTATION)).intValue() + 270) % dc1394.DC1394_COLOR_CODING_RGB16S;
                }
                ...
                if (points != null) {
                    ...
                    for (int i = 0; i < points.length; i++) {
                        points[i] = new ResultPoint((((float) height) - points[i].getY()) - BaseField.BORDER_WIDTH_THIN, points[i].getX());
                    }
                }
            } else {
                throw nfe;
                ...
                while (attempt < 2) {
                    ...
                    try {
                        ...
                        if (attempt == 1) {
                            ...
                            if (points != null) {
                                points[0] = new ResultPoint((((float) width) - points[0].getX()) - BaseField.BORDER_WIDTH_THIN, points[0].getY());
                                points[1] = new ResultPoint((((float) width) - points[1].getX()) - BaseField.BORDER_WIDTH_THIN, points[1].getY());
                            }
                        }
                        return result;
