...
public class RealSense$rs_device$On_event_rs_device_rs_timestamp_data_Pointer extends FunctionPointer {
    ...
    public RealSense$rs_device$On_event_rs_device_rs_timestamp_data_Pointer(Pointer p) {
        super(p);
    }

    protected RealSense$rs_device$On_event_rs_device_rs_timestamp_data_Pointer() {
        allocate();
    }
}
