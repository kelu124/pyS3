...
public class SizeTPointer extends Pointer {
    ...
    public SizeTPointer(long size) {
        try {
            ...
            OutOfMemoryError e22 = new OutOfMemoryError("Cannot allocate new SizeTPointer(" + size + "): totalBytes = " + Pointer.formatBytes(Pointer.totalBytes()) + ", physicalBytes = " + Pointer.formatBytes(Pointer.physicalBytes()));
            e22.initCause(e2);
            throw e22;
        }
    }
