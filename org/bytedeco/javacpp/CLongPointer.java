...
public class CLongPointer extends Pointer {
    ...
    public CLongPointer(long size) {
        try {
            ...
            OutOfMemoryError e22 = new OutOfMemoryError("Cannot allocate new CLongPointer(" + size + "): totalBytes = " + Pointer.formatBytes(Pointer.totalBytes()) + ", physicalBytes = " + Pointer.formatBytes(Pointer.physicalBytes()));
            e22.initCause(e2);
            throw e22;
        }
    }
