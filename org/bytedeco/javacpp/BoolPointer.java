...
public class BoolPointer extends Pointer {
    ...
    public BoolPointer(long size) {
        try {
            ...
            OutOfMemoryError e22 = new OutOfMemoryError("Cannot allocate new BoolPointer(" + size + "): totalBytes = " + Pointer.formatBytes(Pointer.totalBytes()) + ", physicalBytes = " + Pointer.formatBytes(Pointer.physicalBytes()));
            e22.initCause(e2);
            throw e22;
        }
    }
