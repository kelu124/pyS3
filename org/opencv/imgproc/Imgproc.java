...
public class Imgproc {
    ...
    public static void adaptiveBilateralFilter(Mat src, Mat dst, Size ksize, double sigmaSpace, double maxSigmaColor, Point anchor, int borderType) {
        adaptiveBilateralFilter_0(src.nativeObj, dst.nativeObj, ksize.width, ksize.height, sigmaSpace, maxSigmaColor, anchor.f203x, anchor.f204y, borderType);
    }
    ...
    public static void adaptiveBilateralFilter(Mat src, Mat dst, Size ksize, double sigmaSpace, double maxSigmaColor, Point anchor) {
        adaptiveBilateralFilter_1(src.nativeObj, dst.nativeObj, ksize.width, ksize.height, sigmaSpace, maxSigmaColor, anchor.f203x, anchor.f204y);
    }
    ...
    public static void blur(Mat src, Mat dst, Size ksize, Point anchor, int borderType) {
        blur_0(src.nativeObj, dst.nativeObj, ksize.width, ksize.height, anchor.f203x, anchor.f204y, borderType);
    }

    public static void blur(Mat src, Mat dst, Size ksize, Point anchor) {
        blur_1(src.nativeObj, dst.nativeObj, ksize.width, ksize.height, anchor.f203x, anchor.f204y);
    }
    ...
    public static void boxFilter(Mat src, Mat dst, int ddepth, Size ksize, Point anchor, boolean normalize, int borderType) {
        boxFilter_0(src.nativeObj, dst.nativeObj, ddepth, ksize.width, ksize.height, anchor.f203x, anchor.f204y, normalize, borderType);
    }

    public static void boxFilter(Mat src, Mat dst, int ddepth, Size ksize, Point anchor, boolean normalize) {
        boxFilter_1(src.nativeObj, dst.nativeObj, ddepth, ksize.width, ksize.height, anchor.f203x, anchor.f204y, normalize);
    }
    ...
    public static void dilate(Mat src, Mat dst, Mat kernel, Point anchor, int iterations, int borderType, Scalar borderValue) {
        dilate_0(src.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.f203x, anchor.f204y, iterations, borderType, borderValue.val[0], borderValue.val[1], borderValue.val[2], borderValue.val[3]);
    }

    public static void dilate(Mat src, Mat dst, Mat kernel, Point anchor, int iterations) {
        dilate_1(src.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.f203x, anchor.f204y, iterations);
    }
    ...
    public static void drawContours(Mat image, List<MatOfPoint> contours, int contourIdx, Scalar color, int thickness, int lineType, Mat hierarchy, int maxLevel, Point offset) {
        drawContours_0(image.nativeObj, Converters.vector_vector_Point_to_Mat(contours, new ArrayList(contours != null ? contours.size() : 0)).nativeObj, contourIdx, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, hierarchy.nativeObj, maxLevel, offset.f203x, offset.f204y);
    }
    ...
    public static void erode(Mat src, Mat dst, Mat kernel, Point anchor, int iterations, int borderType, Scalar borderValue) {
        erode_0(src.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.f203x, anchor.f204y, iterations, borderType, borderValue.val[0], borderValue.val[1], borderValue.val[2], borderValue.val[3]);
    }

    public static void erode(Mat src, Mat dst, Mat kernel, Point anchor, int iterations) {
        erode_1(src.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.f203x, anchor.f204y, iterations);
    }
    ...
    public static void filter2D(Mat src, Mat dst, int ddepth, Mat kernel, Point anchor, double delta, int borderType) {
        filter2D_0(src.nativeObj, dst.nativeObj, ddepth, kernel.nativeObj, anchor.f203x, anchor.f204y, delta, borderType);
    }

    public static void filter2D(Mat src, Mat dst, int ddepth, Mat kernel, Point anchor, double delta) {
        filter2D_1(src.nativeObj, dst.nativeObj, ddepth, kernel.nativeObj, anchor.f203x, anchor.f204y, delta);
    }
    ...
    public static void findContours(Mat image, List<MatOfPoint> contours, Mat hierarchy, int mode, int method, Point offset) {
        ...
        findContours_0(image.nativeObj, contours_mat.nativeObj, hierarchy.nativeObj, mode, method, offset.f203x, offset.f204y);
    ...
    public static int floodFill(Mat image, Mat mask, Point seedPoint, Scalar newVal, Rect rect, Scalar loDiff, Scalar upDiff, int flags) {
        ...
        int retVal = floodFill_0(image.nativeObj, mask.nativeObj, seedPoint.f203x, seedPoint.f204y, newVal.val[0], newVal.val[1], newVal.val[2], newVal.val[3], rect_out, loDiff.val[0], loDiff.val[1], loDiff.val[2], loDiff.val[3], upDiff.val[0], upDiff.val[1], upDiff.val[2], upDiff.val[3], flags);
        if (rect != null) {
            rect.f205x = (int) rect_out[0];
            rect.f206y = (int) rect_out[1];
    ...
    public static int floodFill(Mat image, Mat mask, Point seedPoint, Scalar newVal) {
        return floodFill_1(image.nativeObj, mask.nativeObj, seedPoint.f203x, seedPoint.f204y, newVal.val[0], newVal.val[1], newVal.val[2], newVal.val[3]);
    }
    ...
    public static void getRectSubPix(Mat image, Size patchSize, Point center, Mat patch, int patchType) {
        getRectSubPix_0(image.nativeObj, patchSize.width, patchSize.height, center.f203x, center.f204y, patch.nativeObj, patchType);
    }

    public static void getRectSubPix(Mat image, Size patchSize, Point center, Mat patch) {
        getRectSubPix_1(image.nativeObj, patchSize.width, patchSize.height, center.f203x, center.f204y, patch.nativeObj);
    }

    public static Mat getRotationMatrix2D(Point center, double angle, double scale) {
        return new Mat(getRotationMatrix2D_0(center.f203x, center.f204y, angle, scale));
    }

    public static Mat getStructuringElement(int shape, Size ksize, Point anchor) {
        return new Mat(getStructuringElement_0(shape, ksize.width, ksize.height, anchor.f203x, anchor.f204y));
    }
    ...
    public static void goodFeaturesToTrack(Mat image, MatOfPoint corners, int maxCorners, double qualityLevel, double minDistance, Mat mask, int blockSize, boolean useHarrisDetector, double k) {
        int i = maxCorners;
        double d = qualityLevel;
        double d2 = minDistance;
        goodFeaturesToTrack_0(image.nativeObj, corners.nativeObj, i, d, d2, mask.nativeObj, blockSize, useHarrisDetector, k);
    }
    ...
    public static void grabCut(Mat img, Mat mask, Rect rect, Mat bgdModel, Mat fgdModel, int iterCount, int mode) {
        grabCut_0(img.nativeObj, mask.nativeObj, rect.f205x, rect.f206y, rect.width, rect.height, bgdModel.nativeObj, fgdModel.nativeObj, iterCount, mode);
    }

    public static void grabCut(Mat img, Mat mask, Rect rect, Mat bgdModel, Mat fgdModel, int iterCount) {
        grabCut_1(img.nativeObj, mask.nativeObj, rect.f205x, rect.f206y, rect.width, rect.height, bgdModel.nativeObj, fgdModel.nativeObj, iterCount);
    }
    ...
    public static void minEnclosingCircle(MatOfPoint2f points, Point center, float[] radius) {
        ...
        if (center != null) {
            center.f203x = center_out[0];
            center.f204y = center_out[1];
        }
        if (radius != null) {
    ...
    public static void morphologyEx(Mat src, Mat dst, int op, Mat kernel, Point anchor, int iterations, int borderType, Scalar borderValue) {
        morphologyEx_0(src.nativeObj, dst.nativeObj, op, kernel.nativeObj, anchor.f203x, anchor.f204y, iterations, borderType, borderValue.val[0], borderValue.val[1], borderValue.val[2], borderValue.val[3]);
    }

    public static void morphologyEx(Mat src, Mat dst, int op, Mat kernel, Point anchor, int iterations) {
        morphologyEx_1(src.nativeObj, dst.nativeObj, op, kernel.nativeObj, anchor.f203x, anchor.f204y, iterations);
    }
    ...
    public static double pointPolygonTest(MatOfPoint2f contour, Point pt, boolean measureDist) {
        return pointPolygonTest_0(contour.nativeObj, pt.f203x, pt.f204y, measureDist);
    }
    ...
    public static void sepFilter2D(Mat src, Mat dst, int ddepth, Mat kernelX, Mat kernelY, Point anchor, double delta, int borderType) {
        sepFilter2D_0(src.nativeObj, dst.nativeObj, ddepth, kernelX.nativeObj, kernelY.nativeObj, anchor.f203x, anchor.f204y, delta, borderType);
    }

    public static void sepFilter2D(Mat src, Mat dst, int ddepth, Mat kernelX, Mat kernelY, Point anchor, double delta) {
        sepFilter2D_1(src.nativeObj, dst.nativeObj, ddepth, kernelX.nativeObj, kernelY.nativeObj, anchor.f203x, anchor.f204y, delta);
    }
