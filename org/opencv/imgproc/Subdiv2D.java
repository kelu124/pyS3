...
public class Subdiv2D {
    ...
    public Subdiv2D(Rect rect) {
        this.nativeObj = Subdiv2D_1(rect.f205x, rect.f206y, rect.width, rect.height);
    }
    ...
    public int edgeDst(int edge, Point dstpt) {
        ...
        if (dstpt != null) {
            dstpt.f203x = dstpt_out[0];
            dstpt.f204y = dstpt_out[1];
        }
        return retVal;
    }
    ...
    public int edgeOrg(int edge, Point orgpt) {
        ...
        if (orgpt != null) {
            orgpt.f203x = orgpt_out[0];
            orgpt.f204y = orgpt_out[1];
        }
        return retVal;
    }
    ...
    public int findNearest(Point pt, Point nearestPt) {
        ...
        int retVal = findNearest_0(this.nativeObj, pt.f203x, pt.f204y, nearestPt_out);
        if (nearestPt != null) {
            nearestPt.f203x = nearestPt_out[0];
            nearestPt.f204y = nearestPt_out[1];
        }
        return retVal;
    }

    public int findNearest(Point pt) {
        return findNearest_1(this.nativeObj, pt.f203x, pt.f204y);
    }
    ...
    public void getVoronoiFacetList(MatOfInt idx, List<MatOfPoint2f> facetList, MatOfPoint2f facetCenters) {
        ...
        getVoronoiFacetList_0(this.nativeObj, idx_mat.nativeObj, facetList_mat.nativeObj, facetCenters.nativeObj);
        Converters.Mat_to_vector_vector_Point2f(facetList_mat, facetList);
    }

    public void initDelaunay(Rect rect) {
        initDelaunay_0(this.nativeObj, rect.f205x, rect.f206y, rect.width, rect.height);
    }

    public int insert(Point pt) {
        return insert_0(this.nativeObj, pt.f203x, pt.f204y);
    }
    ...
    public int locate(Point pt, int[] edge, int[] vertex) {
        ...
        int retVal = locate_0(this.nativeObj, pt.f203x, pt.f204y, edge_out, vertex_out);
        if (edge != null) {
