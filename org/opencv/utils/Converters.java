...
public class Converters {
    ...
    public static Mat vector_Point_to_Mat(List<Point> pts, int typeDepth) {
        ...
        switch (typeDepth) {
            case 4:
                ...
                for (i = 0; i < count; i++) {
                    p = (Point) pts.get(i);
                    buff[i * 2] = (int) p.f203x;
                    buff[(i * 2) + 1] = (int) p.f204y;
                }
                res.put(0, 0, buff);
                return res;
            case 5:
                ...
                for (i = 0; i < count; i++) {
                    p = (Point) pts.get(i);
                    buff2[i * 2] = (float) p.f203x;
                    buff2[(i * 2) + 1] = (float) p.f204y;
                }
                res.put(0, 0, buff2);
                return res;
            case 6:
    ...
    public static Mat vector_Point3_to_Mat(List<Point3> pts, int typeDepth) {
        ...
        switch (typeDepth) {
            case 4:
                ...
                for (i = 0; i < count; i++) {
                    p = (Point3) pts.get(i);
                    buff[i * 3] = (int) p.f200x;
                    buff[(i * 3) + 1] = (int) p.f201y;
                    buff[(i * 3) + 2] = (int) p.f202z;
                }
                res.put(0, 0, buff);
                return res;
            case 5:
                ...
                for (i = 0; i < count; i++) {
                    p = (Point3) pts.get(i);
                    buff2[i * 3] = (float) p.f200x;
                    buff2[(i * 3) + 1] = (float) p.f201y;
                    buff2[(i * 3) + 2] = (float) p.f202z;
                }
                res.put(0, 0, buff2);
                return res;
            case 6:
    ...
    public static Mat vector_Mat_to_Mat(List<Mat> mats) {
        ...
        for (int i = 0; i < count; i++) {
            long addr = ((Mat) mats.get(i)).nativeObj;
    ...
    public static Mat vector_float_to_Mat(List<Float> fs) {
        ...
        for (int i = 0; i < count; i++) {
            buff[i] = ((Float) fs.get(i)).floatValue();
        }
        res.put(0, 0, buff);
        return res;
    }
    ...
    public static Mat vector_uchar_to_Mat(List<Byte> bs) {
        ...
        for (int i = 0; i < count; i++) {
            buff[i] = ((Byte) bs.get(i)).byteValue();
        }
        res.put(0, 0, buff);
        return res;
    }
    ...
    public static Mat vector_int_to_Mat(List<Integer> is) {
        ...
        for (int i = 0; i < count; i++) {
            buff[i] = ((Integer) is.get(i)).intValue();
        }
        res.put(0, 0, buff);
        return res;
    }
    ...
    public static Mat vector_KeyPoint_to_Mat(List<KeyPoint> kps) {
        ...
        for (int i = 0; i < count; i++) {
            KeyPoint kp = (KeyPoint) kps.get(i);
            buff[i * 7] = kp.pt.f203x;
            buff[(i * 7) + 1] = kp.pt.f204y;
    ...
    public static Mat vector_double_to_Mat(List<Double> ds) {
        ...
        for (int i = 0; i < count; i++) {
            buff[i] = ((Double) ds.get(i)).doubleValue();
        }
        res.put(0, 0, buff);
        return res;
    }
