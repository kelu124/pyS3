...
public class Mat {
    ...
    public Mat(Mat m, Rect roi) {
        this.nativeObj = n_Mat(m.nativeObj, roi.f206y, roi.f206y + roi.height, roi.f205x, roi.f205x + roi.width);
    }
    ...
    public Mat submat(Rect roi) {
        return new Mat(n_submat(this.nativeObj, roi.f205x, roi.f206y, roi.width, roi.height));
    }
