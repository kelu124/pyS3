...
class AsyncServiceHelper {
    ...
    protected ServiceConnection mServiceConnection = new C12743();
    protected LoaderCallbackInterface mUserAppCallback;

    class C12743 implements ServiceConnection {

        class C12721 implements InstallCallbackInterface {
            C12721() {
            }
        ...
        class C12732 implements InstallCallbackInterface {
            C12732() {
            }
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            AsyncServiceHelper.this.mEngineService = Stub.asInterface(service);
            ...
            try {
                ...
                if (path != null && path.length() != 0) {
                    ...
                    AsyncServiceHelper.this.mUserAppCallback.onPackageInstall(1, new C12732());
                } else {
                    AsyncServiceHelper.this.mUserAppCallback.onPackageInstall(0, new C12721());
                }
            } catch (RemoteException e) {
                e.printStackTrace();
                Log.d(AsyncServiceHelper.TAG, "Init finished with status 255");
    ...
    private boolean initOpenCVLibs(String Path, String Libs) {
        ...
        if (Libs == null || Libs.length() == 0) {
            return true & loadLibrary(Path + File.separator + "libopencv_java.so");
        }
