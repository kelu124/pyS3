...
public final class OperatorWindowWithSize<T> implements Observable$Operator<Observable<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C15041 implements Action0 {
            C15041() {
            }
        ...
        class C15052 implements Producer {
            C15052() {
            }
        ...
        void init() {
            this.child.add(Subscriptions.create(new C15041()));
            this.child.setProducer(new C15052());
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class C15072 implements Producer {
            C15072() {
            }
        ...
        void init() {
            this.child.add(Subscriptions.create(new C15061()));
            this.child.setProducer(new C15072());
        }
