...
public final class OperatorMapNotification<T, R> implements Observable$Operator<R, T> {
    ...
    final class MapNotificationSubscriber extends Subscriber<T> {
        ...
        private final Subscriber<? super R> f213o;
        ...
        void init() {
            this.f213o.setProducer(this.emitter);
        }
        ...
        public void onCompleted() {
            try {
                ...
                Exceptions.throwOrReport(e, this.f213o);
            }
        }
        ...
        public void onError(Throwable e) {
            try {
                ...
                Exceptions.throwOrReport(e2, this.f213o);
            }
        }
        ...
        public void onNext(T t) {
            try {
                ...
                Exceptions.throwOrReport(e, this.f213o, t);
            }
        }
    }
