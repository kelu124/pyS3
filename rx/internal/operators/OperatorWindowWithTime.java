...
public final class OperatorWindowWithTime<T> implements Observable$Operator<Observable<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C15112 implements Action0 {
            C15112() {
            }
        ...
        void scheduleExact() {
            this.worker.schedulePeriodically(new C15112(), 0, OperatorWindowWithTime.this.timespan, OperatorWindowWithTime.this.unit);
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        void scheduleChunk() {
            this.worker.schedulePeriodically(new C15121(), OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.unit);
        }
