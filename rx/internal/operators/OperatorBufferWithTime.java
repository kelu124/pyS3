...
public final class OperatorBufferWithTime<T> implements Observable$Operator<List<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C13751 implements Action0 {
            C13751() {
            }
        ...
        void scheduleExact() {
            this.inner.schedulePeriodically(new C13751(), OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.unit);
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class C13761 implements Action0 {
            C13761() {
            }
        ...
        void scheduleChunk() {
            this.inner.schedulePeriodically(new C13761(), OperatorBufferWithTime.this.timeshift, OperatorBufferWithTime.this.timeshift, OperatorBufferWithTime.this.unit);
        }
