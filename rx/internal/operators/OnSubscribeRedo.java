...
public final class OnSubscribeRedo<T> implements Observable$OnSubscribe<T> {
    static final Func1<Observable<? extends Notification<?>>, Observable<?>> REDO_INFINITE = new C13461();
    ...
    static class C13461 implements Func1<Observable<? extends Notification<?>>, Observable<?>> {

        class C13451 implements Func1<Notification<?>, Notification<?>> {
            C13451() {
            }
        ...
        public Observable<?> call(Observable<? extends Notification<?>> ts) {
            return ts.map(new C13451());
        }
    }

    class C13503 implements Observable$Operator<Notification<?>, Notification<?>> {
        C13503() {
        }
    ...
    public static final class RedoFinite implements Func1<Observable<? extends Notification<?>>, Observable<?>> {
        ...
        class C13541 implements Func1<Notification<?>, Notification<?>> {
            int num = 0;
        ...
        public Observable<?> call(Observable<? extends Notification<?>> ts) {
            return ts.map(new C13541()).dematerialize();
        }
    }
    ...
    public static final class RetryWithPredicate implements Func1<Observable<? extends Notification<?>>, Observable<? extends Notification<?>>> {
        ...
        class C13551 implements Func2<Notification<Integer>, Notification<?>, Notification<Integer>> {
            C13551() {
            }
        ...
        public Observable<? extends Notification<?>> call(Observable<? extends Notification<?>> ts) {
            return ts.scan(Notification.createOnNext(Integer.valueOf(0)), new C13551());
        }
    }
    ...
    public void call(Subscriber<? super T> child) {
        ...
        Action0 subscribeToSource = new Action0() {
            ...
            public void call() {
                if (!subscriber.isUnsubscribed()) {
                    Subscriber<T> terminalDelegatingSubscriber = new C13471();
        ...
        final Observable<?> restarts = (Observable) this.controlHandlerFunction.call(terminals.lift(new C13503()));
