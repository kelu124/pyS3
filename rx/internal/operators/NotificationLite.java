...
public final class NotificationLite<T> {
    ...
    private static final Object ON_COMPLETED_SENTINEL = new C13371();
    private static final Object ON_NEXT_NULL_SENTINEL = new C13382();

    static class C13371 implements Serializable {
    ...
    static class C13382 implements Serializable {
    ...
    private static class OnErrorSentinel implements Serializable {
        ...
        public String toString() {
            return "Notification=>Error:" + this.f209e;
        }
    }
    ...
    public boolean accept(Observer<? super T> o, Object n) {
        if (n == ON_COMPLETED_SENTINEL) {
            ...
            o.onError(((OnErrorSentinel) n).f209e);
            return true;
        } else {
            o.onNext(n);
            return false;
    ...
    public Throwable getError(Object n) {
        return ((OnErrorSentinel) n).f209e;
    }
}
