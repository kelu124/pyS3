...
public final class OperatorObserveOn<T> implements Observable$Operator<T, T> {
    ...
    private static final class ObserveOnSubscriber<T> extends Subscriber<T> {
        final Action0 action = new C14192();
        ...
        class C14181 implements Producer {
            C14181() {
            }
        ...
        class C14192 implements Action0 {
            C14192() {
            }
        ...
        void init() {
            ...
            this.child.setProducer(new C14181());
    ...
    static final class ScheduledUnsubscribe extends AtomicInteger implements Subscription {
        ...
        class C14201 implements Action0 {
            C14201() {
            }
        ...
        public void unsubscribe() {
            if (getAndSet(1) == 0) {
                this.worker.schedule(new C14201());
            }
        }
    }
