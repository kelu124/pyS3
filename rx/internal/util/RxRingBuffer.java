...
public class RxRingBuffer implements Subscription {
    ...
    public static ObjectPool<Queue<Object>> SPMC_POOL = new C15252();
    public static ObjectPool<Queue<Object>> SPSC_POOL = new C15241();
    static int _size;
    ...
    static class C15241 extends ObjectPool<Queue<Object>> {
        C15241() {
        }
    ...
    static class C15252 extends ObjectPool<Queue<Object>> {
        C15252() {
        }
